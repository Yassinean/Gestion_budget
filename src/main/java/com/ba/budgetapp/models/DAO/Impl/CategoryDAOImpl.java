...
public class CategoryDAOImpl extends BaseDAO implements CategoryDAO {
   ...
   @Override
    public boolean create(Category category) {
        ...
        try (
            ...
            ps.setLong(1, category.getBudgetId());
   ...
   @Override
    public List<Category> findByBudgetId(Long budgetId) {
        ...
        try (
                ...
                PreparedStatement ps =
                        connection.prepareStatement(FIND_BY_BUDGET)
        ) {
    ...
    @Override
    public Optional<Category> findByTitle(Long budgetId, String title) {
        try (
                Connection connection = getConnection();
    ...
    @Override
    public boolean existsByTitle(Long budgetId, String title) {
        return findByTitle(budgetId, title).isPresent();
    }
}
